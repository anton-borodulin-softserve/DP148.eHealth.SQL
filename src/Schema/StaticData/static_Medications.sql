...
BEGIN
    INSERT INTO [dbo].[Medications]([InternationalName], [Type], [Dose], [Direction], [Instruction])
    VALUES ('Septefrilum', 'Pill', 0.2, 'Oral', 'Septefrilum instruction.');
    INSERT INTO [dbo].[Medications]([InternationalName], [Type], [Dose], [Direction], [Instruction])
    VALUES ('Nise', 'Pill', 100.0, 'Oral', 'Nise instruction.');
    INSERT INTO [dbo].[Medications]([InternationalName], [Type], [Dose], [DoseUnit], [Direction], [Instruction])
