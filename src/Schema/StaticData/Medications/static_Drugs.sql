...
IF ( NOT EXISTS(SELECT *
                FROM   [dbo].[Drugs]) )
BEGIN
    INSERT INTO [dbo].[Drugs]([InternationalName], [Type], [Dose], [Direction], [Instruction])
    VALUES ('Septefrilum', 'Pill', 0.2, 'Oral', 'Septefrilum instruction.');
    INSERT INTO [dbo].[Drugs]([InternationalName], [Type], [Dose], [Direction], [Instruction])
    VALUES ('Nise', 'Pill', 100.0, 'Oral', 'Nise instruction.');
    INSERT INTO [dbo].[Drugs]([InternationalName], [Type], [Dose], [DoseUnit], [Direction], [Instruction])
